...
void main() {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      // Phase 2: Shockwave distortion (0.05s → 0.8s)
      tl.to(u.distortion, {
        value: 6.0,
        duration: 0.15,
        ease: 'power4.out'
      ...
      // Phase 3: Settle back — color fades from white through bright blue to original (0.15s → 2s)
      tl.to(u.raysColor, {
        'value[0]': originalColor[0] * 1.5,
        'value[1]': originalColor[1] * 1.5,
        'value[2]': originalColor[2] * 1.5,
        duration: 0.4,
        ease: 'power2.inOut'
      }, 0.15);

      tl.to(u.raysColor, {
        'value[0]': originalColor[0],
        'value[1]': originalColor[1],
        'value[2]': originalColor[2],
        duration: 1.5,
        ease: 'power2.out'
      }, 0.55);
  ...
  }, [followMouse, lightSpread, raysSpeed, distortion, raysColor, noiseAmount, rayLength]);
